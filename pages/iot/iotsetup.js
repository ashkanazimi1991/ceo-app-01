  ...
  <Layout>
    ...
    >
      ...
      <div className={styles.rightSide} style={{ backgroundColor: "#fff" }}>
        ...
        <h2 style={{ color: "#000" }}>
          جمع آوری اطلاعات به تنهایی سبب هوشمندسازی نمی شود ولی وقتی اطلاعات کسب و کار بصورت گزارش در اختیار مدیران قرار میگیرد باعث می شود مدیر کسب و کار نسبت به گزارشات تصمیم درست بگیرد و کسب و کار خود را در چالش های مختلف هدایت می کند, مجموعه مدیریت آنلاین بسترهای را ارائه میدهد که انواع داده از قبیل داده های صفر و یک ماشین آلات را به زبان قابل درک و روی  نمودار ارائه دهد. ....        
        </h2>
        <button> اطلاعات بیشتر</button>
      </div>
    </div>
