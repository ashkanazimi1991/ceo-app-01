  ...
  <Layout>
    ...
    <div className={styles.section} style={{ background: "#fff" }}>
      <div className={styles.leftSide}>
       <img src="/images/crypto400.jpg" alt="online ceo Company" />
    ...
    >
      <div className={styles.leftSide}>
        ...
        <img src="/images/crypto2004.gif " alt="onlineceo Company" />
      </div>
      <div className={styles.rightSide}>
        <h1 style={{ color: "#ff0000" }}>صرافی های ارز دیجیتال </h1>
        <h2 style={{ color: "#fff" }}>
          صرافی های ارز دیجیتال پلتفرم های هستند که در آن می توانید در عرض چند دقیقه رمز ارز های خود را به انواع واحد های مالی تبدیل کنید, یا خرید و فروش رمزارز انجام دهید, صرافی های بسیاری در جهان هستند که سالهاست به فعالیت خود ادامه می دهند, شما هم می توانید یک صرافی داشته باشید, مجموعه مدیریت آنلاین  .
        </h2>
        <button>اطلاعات بیشتر</button>
      </div>
    </div>
